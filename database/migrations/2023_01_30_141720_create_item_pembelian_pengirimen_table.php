...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('item_pembelian_pengirimen', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('pembelian_id')->references('id')->on('pengirimen')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('item_pembelian_pengirimen');
    }
};
