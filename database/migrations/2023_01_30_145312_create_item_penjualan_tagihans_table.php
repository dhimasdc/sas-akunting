...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('item_penjualan_tagihans', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('penjualan_id')->references('id')->on('penjualan__tagihans')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('item_penjualan_tagihans');
    }
};
