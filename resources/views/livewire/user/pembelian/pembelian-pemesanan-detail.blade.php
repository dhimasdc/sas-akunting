<div class="overflow-x-hiden">
    ...
    <div class="flex items-center space-x-2 mb-5">
        ...
        <span class="text-gray-400 text-sm">/</span>
        <a href="{{ route('user.pembelian.pemesanan') }}" class="text-gray-400 hover:text-primary-500">Pemesanan</a>
        <span class="text-gray-400 text-sm">/</span>
    ...
    <div class="bg-gray-50 rounded p-8 soft-scrollbar mb-12 dark:bg-gray-800 transition duration-200 ">
        <div class="flex content-center mb-10">
            <div class="flex flex-none w-2/3">
                <h4 class="text-2xl font-semibold dark:text-gray-100">Detil Pemesanan Pembelian - {{ $pemesanan->kode }}
                </h4>
            </div>
            <div class="flex flex-initial w-1/3 justify-end">

                <x-button warning label="Kembali" icon="chevron-left" href="{{ route('user.pembelian.pemesanan') }}" />
                ...
                <div class="flex flex-row-reverse">
                    ...
                    <div class="ml-2">
                        <x-button blue label="Buat Tagihan" icon="plus"
                            href="{{ route('user.pembelian.tagihan.tambah.buat', ['tipe' => 'pemesanan', 'buat_id' => $pemesanan->id]) }}" />
                    </div>
                    <div class="ml-2">
                        <x-button green label="Buat Pengiriman" icon="plus"
                            href="{{ route('user.pembelian.pengiriman.tambah', ['pemesanan_id' => $pemesanan_id]) }}" />
                    </div>
