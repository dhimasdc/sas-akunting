<div class="overflow-x-hiden">
    ...
    <div class="flex items-center space-x-2 mb-5">
        ...
        <span class="text-gray-400 text-sm">/</span>
        <a href="{{ route('user.pembelian.pengiriman') }}" class="text-gray-400 hover:text-primary-500">Pengiriman</a>
        <span class="text-gray-400 text-sm">/</span>
    ...
    <div class="bg-gray-50 rounded p-8 soft-scrollbar mb-12 dark:bg-gray-800 transition duration-200 ">
        <div class="flex content-center mb-10">
            <div class="flex flex-none w-2/3">
                <h4 class="text-2xl font-semibold dark:text-gray-100">Detil Pengiriman Pembelian -
                    {{ $pengiriman->kode }}</h4>
            </div>
            <div class="flex flex-initial w-1/3 justify-end">

                <x-button warning label="Kembali" icon="chevron-left" href="{{ route('user.pembelian.pengiriman') }}" />
        ...
        <div class="border border-grey-200 grid grid-cols-1 gap-2 rounded">
                ...
                <div class="flex flex-col-2 flex-row-reverse">
                    ...
                    <div class="ml-2">
                        <x-button blue label="Buat Tagihan" icon="plus"
                            href="{{ route('user.pembelian.tagihan.tambah.buat', ['tipe' => 'pengiriman', 'buat_id' => $pengiriman->id]) }}" />
                    </div>
                    <div class="ml-2">
            ...
            <div class="mt-0 px-6 pt-6 grid grid-cols-3 gap-2">
                <div class="flex flex-col">
                    <span class="text-base font-medium  dark:text-white">Vendor</span>
            ...
            <div class="mt-0 px-6 grid grid-cols-3">
                ...
                <div class="flex flex-col">
                    ...
                    <a href="{{ route('user.pembelian.pemesanan.detail', ['pemesanan_id' => $pengiriman->pemesanan_pembelian->id]) }}"
                        class="font-semibold text-primary-500 dark:text-primary-300 hover:underline hover:text-primary-700 dark:hover:text-primary-500">{{ $pengiriman->pemesanan_pembelian->kode }}</a>
                </div>
            </div>
            <div class="mt-0 px-6 grid grid-cols-3">
                <div class="flex flex-col">
