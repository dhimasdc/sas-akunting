<div class="">
    <div class="w-full flex flex-col lg:flex-row items-center justify-between bg-white mb-11 px-2 py-4 rounded-lg shadow-lg dark:bg-slate-900">
        <span class="text-xl font-bold m-3 dark:text-white">Dashboard</span>
        <div  class="m-3"><input type="text" name="daterange" value="" class="rounded-lg"/></div>
        
    </div>
    
    <!-- start::Stats -->
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10">
        <div class="px-6 py-6 bg-white rounded-lg shadow-xl dark:bg-slate-900">
            <div class="flex items-center justify-between">
                <span class="font-bold text-sm text-info-600 dark:text-primary-300">Total Revenue</span>
        ...
        <div class="px-6 py-6 bg-white rounded-lg shadow-xl dark:bg-slate-900">
            <div class="flex items-center justify-between">
                <span class="font-bold text-sm text-green-600">Pesanan Baru</span>
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <div class="flex flex-col">
                    <div class="flex items-end">
                        <span class="text-lg lg:text-xl font-bold dark:text-white">22</span>
                        <div class="flex items-center ml-2 mb-1">
                            <svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
        ...
        <div class="px-6 py-6 bg-white rounded-lg shadow-xl dark:bg-slate-900">
            <div class="flex items-center justify-between">
                <span class="font-bold text-sm text-blue-600">Kontak</span>
                <span class="text-xs bg-gray-200 hover:bg-gray-500 text-gray-500 hover:text-gray-200 px-2 py-1 rounded-lg transition duration-200 cursor-default">7 days</span>
            </div>
            <div class="flex items-center justify-between mt-6">
                <div>
                ...
                <div class="flex flex-col">
                    <div class="flex items-end">
                        <span class="text-lg lg:text-xl font-bold dark:text-white">14</span>
                        <div class="flex items-center ml-2 mb-1">
                            <svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
        ...
        <div class="px-6 py-6 bg-white rounded-lg shadow-xl dark:bg-slate-900">
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <div class="flex flex-col">
                    <div class="flex items-end">
                        <span class="text-lg lg:text-xl font-bold dark:text-white">10,644</span>
                        <div class="flex items-center ml-2 mb-1">
    ...
    <!-- start::Charts -->
    <div class="w-full flex flex-col lg:flex-row items-center justify-between bg-white my-16 px-2 py-4 rounded-lg shadow-lg dark:bg-slate-900">
        <div class="w-full lg:w-2/3">
            <h4 class="text-center text-xl font-semibold mb-4 dark:text-white">Statistic 1</h4>
            <div>
        ...
        <div class="w-full lg:w-1/3 mt-10 lg:mt-0">
            <h4 class="text-center text-xl font-semibold mb-4 dark:text-white">Statistic 2</h4>
            <div>                          
    ...
    <div class="flex flex-col xl:flex-row space-y-4 xl:space-y-0 xl:space-x-4">
        ...
        <div class="w-full xl:w-1/3 p-6 space-y-6 bg-white rounded-lg shadow-xl capitalize dark:bg-slate-900">
            <h4 class="text-center text-xl font-semibold mb-4 dark:text-white">Project completion</h4>
            <section 
                ...
                <div class="flex items-center justify-center">
                    <template x-for="item in items">
                        <button x-text="item.name"
                            class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-1.5 mx-1 rounded-lg transition duration-200 dark:text-white"
        ...
        <div 
            ...
            class="w-full xl:w-1/3 p-6 space-y-6 bg-white shadow-xl rounded-lg dark:bg-slate-900"
        >
            <h4 class="text-xl font-semibold mb-4 capitalize dark:text-white">Project overview</h4>
            ...
            <div class="grid grid-cols-2 border-t-2 border-gray-300 pt-4">
                <div class="flex flex-col items-center justify-center border-r-2 border-gray-300">
                    <span class="text-sm text-gray-600 dark:text-white">Completed</span>
                    <span class="text-3xl font-bold text-gray-800 dark:text-white" x-text="`${project.completed}`"></span>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <span class="text-sm text-gray-600 dark:text-white">In Progress</span>
                    <span class="text-3xl font-bold text-gray-800 dark:text-white" x-text="`${project.in_progress}`"></span>
                </div>
            </div>
        </div>
        ...
        <!-- start::Total stats -->
        <div class="w-full xl:w-1/3 p-6 space-y-6 bg-white shadow-xl rounded-lg dark:bg-slate-900">
            <h4 class="text-xl font-semibold mb-4 capitalize dark:text-white">Order stats</h4>
            <div class="grid grid-cols-2 gap-4 h-40">
                <div class="bg-green-300 bg-opacity-20 text-green-700 flex flex-col items-center justify-center rounded-lg">
                    <span class="text-4xl font-bold dark:text-white">184</span>
                    <span>Completed</span>
                </div>
                <div class="bg-indigo-300 bg-opacity-20 text-indigo-700 flex flex-col items-center justify-center rounded-lg">
                    <span class="text-4xl font-bold dark:text-white">54</span>
                    <span>Shipped</span>
                </div>
            </div>
            <div class="grid grid-cols-3 gap-2 h-32">
                ...
                <div class="bg-blue-300 bg-opacity-20 text-blue-700 flex flex-col items-center justify-center rounded-lg">
                    <span class="text-3xl font-bold dark:text-white">24</span>
                    <span>Refunded</span>
                </div>
                <div class="bg-red-300 bg-opacity-20 text-red-700 flex flex-col items-center justify-center rounded-lg">
                    <span class="text-3xl font-bold dark:text-white">37</span>
                    <span>Canceled</span>
                </div>
            </div>
        </div>
    ...
    <div class="flex flex-col xl:flex-row my-16 space-y-4 xl:space-y-0 xl:space-x-4 ">
        <!-- start::Schedule -->
        <div class="w-full xl:w-2/3 bg-white shadow-xl rounded-lg space-y-1 dark:bg-slate-900">
            <h4 class="text-xl font-semibold m-6 capitalize dark:text-white">Schedule</h4>
            <!-- start::Task in calendar -->
            <div class="flex">
                <div class="w-32 flex flex-col items-center justify-center px-2 bg-blue-500 text-gray-100">
                    <span class="text-sm lg:text-base font-semibold dark:text-white">24 Sep</span>
                    <span class="text-xs lg:text-sm text-gray-200 dark:text-white">1:30 PM</span>
                </div>
                <div class="w-full flex justify-between p-4 bg-gray-100 hover:bg-gray-200 transition duration-200 dark:bg-gray-800">
                    <div class="flex flex-col justify-center">
                        <span class="xl:text-lg dark:text-white">New project requirements meeting</span>
                        <span class="flex items-start dark:text-white">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            <span class="text-xs lg:text-sm dark:text-white">
                                Meeting room 3
                            </span>
                        </span>
                    </div>
                    <div class="flex items-center">
                        <span class="text-xs lg:text-sm bg-gray-300 p-2 rounded-lg text-center dark:text-white">2 hours</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex">
                <div class="w-32 flex flex-col items-center justify-center px-2 bg-blue-500 text-gray-100">
                    <span class="text-sm lg:text-base font-semibold dark:text-white">27 Sep</span>
                    <span class="text-xs lg:text-sm text-gray-200 dark:text-white">11:30 AM</span>
                </div>
                <div class="w-full flex justify-between p-4 bg-gray-100 hover:bg-gray-200 transition duration-200 dark:bg-gray-800">
                    <div class="flex flex-col justify-center">
                        <span class="xl:text-lg dark:text-white">Weekly dev team meeting</span>
                        <span class="flex items-start dark:text-white">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            <span class="text-xs lg:text-sm dark:text-white">
                                Meeting room 2
                    ...
                    <div class="flex items-center">
                        <span class="text-xs lg:text-sm bg-gray-300 p-2 rounded-lg text-center dark:text-white">3 days</span>
                    </div>
                </div>
            </div>
            <!-- end::Task in calendar -->
            ...
            <div class="flex">
                <div class="w-32 flex flex-col items-center justify-center px-2 bg-blue-500 text-gray-100">
                    <span class="text-sm lg:text-base font-semibold dark:text-white">27 Sep</span>
                    <span class="text-xs lg:text-sm text-gray-200 dark:text-white">3:30 PM</span>
                </div>
                <div class="w-full flex justify-between p-4 bg-gray-100 hover:bg-gray-200 transition duration-200 dark:bg-gray-800">
                    <div class="flex flex-col justify-center">
                        <span class="xl:text-lg dark:text-white">Meeting with Laravel client</span>
                        <span class="flex items-start dark:text-white">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            <span class="text-xs lg:text-sm dark:text-white">
                                Zoom
            ...
            <div class="flex">
                <div class="w-32 flex flex-col items-center justify-center px-2 bg-blue-500 text-gray-100">
                    <span class="text-sm lg:text-base font-semibold dark:text-white">29 Sep</span>
                    <span class="text-xs lg:text-sm text-gray- dark:text-white">10:00 AM</span>
                </div>
                <div class="w-full flex justify-between p-4 bg-gray-100 hover:bg-gray-200 transition duration-200 dark:bg-gray-800">
                    <div class="flex flex-col justify-center">
                        <span class="xl:text-lg dark:text-white">Meeting with Tailwind CSS client</span>
                        <span class="flex items-start dark:text-white">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            <span class="text-xs lg:text-sm dark:text-white">
                                Zoom
                    ...
                    <div class="flex items-center">
                        <span class="text-xs lg:text-sm bg-gray-300 p-2 rounded-lg text-center dark:text-white">5 days</span>
                    </div>
                </div>
            </div>
            <!-- end::Task in calendar -->
            ...
            <div class="flex">
                <div class="w-32 flex flex-col items-center justify-center px-2 bg-blue-500 text-gray-100">
                    <span class="text-sm lg:text-base font-semibold dark:text-white">30 Sep</span>
                    <span class="text-xs lg:text-sm text-gray-200 dark:text-white">8:00 AM</span>
                </div>
                <div class="w-full flex justify-between p-4 bg-gray-100 hover:bg-gray-200 transition duration-200 dark:bg-gray-800">
                    <div class="flex flex-col justify-center">
                        <span class="lg:text-lg dark:text-white">Laracon</span>
                        <span class="flex items-start dark:text-white">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            <span class="text-xs lg:text-sm dark:text-white">
                                Amsterdam
                    ...
                    <div class="flex items-center">
                        <span class="text-xs lg:text-sm bg-gray-300 p-2 rounded-lg text-center dark:text-white">6 days</span>
                    </div>
                </div>
            </div>
            <!-- end::Task in calendar -->
        ...
        <!-- start::Activity -->
        <div class="w-full xl:w-1/3 bg-white rounded-lg shadow-xl px-4 overflow-y-hidden dark:bg-slate-900">
            <h4 class="text-xl font-semibold p-6 capitalize dark:text-white">Aktifitas</h4>
            <div class="relative h-full px-8 pt-2">
                <div class="absolute h-full border border-dashed border-opacity-20 border-secondary"></div>

                <!-- start::Timeline item -->
                <div class="flex items-center w-full my-6 -ml-1.5 dark:text-white">
                    <div class="w-1/12">
                ...
                <div class="flex items-center w-full my-6 -ml-1.5 dark:text-white">
                    ...
                    <div class="w-11/12">
                        <p class="text-sm">
                            <a href="#" class="text-primary-500 font-bold">Harold Hobbs</a> make payment for order <a href="#" class="text-primary-500 font-bold">#OR7546</a>.</p>
                ...
                <div class="flex items-center w-full my-6 -ml-1.5 dark:text-white">
                    <div class="w-1/12">
                        <div class="w-3.5 h-3.5 bg-primary-500 rounded-full"></div>
                    </div>
                    <div class="w-11/12">
                        <p class="text-sm">Invoice <a href="#" class="text-primary-500 font-bold">#4563</a> was created.</p>
                ...
                <div class="flex items-center w-full my-6 -ml-1.5 dark:text-white">
                    ...
                    <div class="w-11/12">
                        <p class="text-sm"><a href="#" class="text-primary-500 font-bold">Cecilia Hendric</a> just confirmed email address.</p>
                ...
                <div class="flex items-center w-full my-6 -ml-1.5 dark:text-white">
                    ...
                    <div class="w-11/12">
                        <p class="text-sm">New order received <a href="#" class="text-primary-500 font-bold">#OR9653</a>.</p>
                ...
                <div class="flex items-center w-full my-6 -ml-1.5 dark:text-white">
                    ...
                    <div class="w-11/12">
                        <p class="text-sm"><a href="#" class="text-primary-500 font-bold">Jane Stillman</a> canceled order <a href="#" class="text-primary font-bold">#OR7451</a>.</p>
                        <p class="text-xs text-gray-500">2 hours ago</p>
                    </div>
                </div>
                <!-- end::Timeline item -->
    ...
    <!-- start::Table -->
    <div class="bg-white rounded-lg px-8 py-6 overflow-x-scroll custom-scrollbar dark:bg-slate-900">
        <h4 class="text-xl font-semibold dark:text-white">Recent transactions</h4>
        <table class="w-full my-8 whitespace-nowrap">
            <thead class="bg-slate-500 text-gray-100 font-bold dark:text-white">
                <td>
                </td>
                <td class="py-2 pl-2">
                    Order ID
            ...
            <tbody class="text-sm dark:text-white">
                <tr class="bg-gray-100 dark:bg-gray-800 hover:bg-primary-500 hover:bg-opacity-20 transition duration-200">
                    <td class="py-3 pl-2">
                    ...
                    <td class="py-3 pl-2">
                        <a href="#" class="bg-primary-500 hover:bg-opacity-90 px-2 py-1 mr-2 text-gray-100 rounded-lg">View Details</a>
                    </td>
                </tr>
                <tr class="bg-gray-200 dark:bg-slate-800 hover:bg-primary-500 hover:bg-opacity-20 transition duration-200">
                    <td class="py-3 pl-2">
                        <input type="checkbox" class="rounded focus:ring-0 checked:bg-red-500 ml-2">
                    </td>
                    <td class="py-3 pl-2">
