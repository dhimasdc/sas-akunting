<div class="overflow-x-hiden">
    ...
    <div class="flex items-center space-x-2 mb-5">
        ...
        <span class="text-gray-400 text-sm">/</span>
        <a href="{{ route('user.penjualan.penawaran') }}" class="text-gray-400 hover:text-primary">Penawaran</a>
        <span class="text-gray-400 text-sm">/</span>
    ...
    <div class="bg-gray-50 rounded p-8 soft-scrollbar mb-12 dark:bg-gray-800 transition duration-200 ">
        <div class="flex content-center mb-10">
            <div class="flex flex-none w-1/3">
                <h4 class="text-2xl font-semibold dark:text-gray-100">Detil Penawaran - {{ $penawaran->kode }}</h4>
            </div>
                    ...
                    @if ($penawaran->status == 'Disetujui')
                        <div class="mx-2">
                            <x-button positive label="Buat Pemesanan" icon="plus"
                                href="{{ route('user.penjualan.pemesanan.tambah.buat', ['penawaran_id' => $penawaran->id]) }}" />
                        </div>
                        <div class="ml-2">
                            <x-button blue label="Buat Tagihan" icon="plus"
                                href="{{ route('user.penjualan.tagihan.tambah.buat', ['tipe' => 'penawaran', 'buat_id' => $penawaran->id]) }}" />
                        </div>
                        <div class="ml-2">
