<div>
    <div
        ...
        <span class="text-xl font-bold m-3 dark:text-white">Overview Penjualan</span>
    ...
    <h1 class="text-xl font-bold dark:text-gray-100 mb-5">TAGIHAN PENJUALAN</h1>
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 mb-10">
        <a href="{{ route('user.penjualan.tagihan') }}"
        ...
        <a href="{{ route('user.penjualan.penawaran') }}"
            class="px-6 py-6 bg-white dark:bg-gray-800 rounded-lg shadow-xl hover:bg-gray-100 hover:shadow-2xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-1 xl:grid-cols-2 gap-10 my-10">
        <div class="px-6 py-6 bg-white dark:text-white dark:bg-gray-800 rounded-lg shadow-xl">
            <h4 class="text-xl capitalize">Penjualan Per Produk Bulan ini</h4>
        ...
        <div class="px-6 py-6 bg-white dark:text-white  dark:bg-gray-800 rounded-lg shadow-xl">
            <h4 class="text-xl capitalize">Penjualan per Pelanggan Bulan Ini</h4>
            <div class="flex flex-row">
                <div class="mt-6 basis-1/2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10 mb-10">
        <a href="{{ route('user.penjualan.pengiriman') }}"
            class="px-6 py-6 bg-white dark:bg-gray-800 rounded-lg shadow-xl hover:bg-gray-100 hover:shadow-2xl">
        ...
        <a href="{{ route('user.penjualan.pemesanan') }}"
            class="px-6 py-6 bg-white dark:bg-gray-800 rounded-lg shadow-xl hover:bg-gray-100 hover:shadow-2xl">
