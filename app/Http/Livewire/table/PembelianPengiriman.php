...
final class PembelianPengiriman extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    ...
    {
        return Pengiriman::query()->where('jenis', '=', 'pembelian');
    }
    ...
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('kode', function (Pengiriman $model) {
                return '<a href="' . route('user.pembelian.pengiriman.detail', ['pengiriman_id' => $model->id]) . '" class="bg-primary-500 p-1 rounded text-white hover:underline">' . ($model->kode) . '</a>';
            })
