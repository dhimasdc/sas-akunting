...
class PembelianTambahPemesanan extends Component
{
    use WithFileUploads;
    ...
    public function addPemesanan()
    {
        ...
        $this->notification()->success('Pemesanan Pembelian Ditambahkan');
    ...
    public function render()
    {
        ...
        return view(
            'livewire.user.pembelian.pembelian-tambah-pemesanan',
